...
{
    public sealed class ParserAndInterpreterResultLine
    {
        public TokenizedTextLine TokenizedTextLine { get; }

        public IReadOnlyList<StatementParserAndInterpreterResult> StatementsAndData { get; }

        public IData? SummarizedResultData { get; }

        public ParserAndInterpreterResultLine(

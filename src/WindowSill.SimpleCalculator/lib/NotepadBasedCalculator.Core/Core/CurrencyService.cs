...
namespace NotepadBasedCalculator.Core.Core
{
    ...
    public /*sealed // Don't make it sealed or Moq won't work*/ class CurrencyService : ICurrencyService
    {
        ...
        private readonly DisposableSempahore _disposableSempahore = new();
        ...
        private static LatestRatesResult? LoadEmbeddedExchangeRates()
        {
            ...
            using Stream? embeddedResourceStream = assembly.GetManifestResourceStream("NotepadBasedCalculator.Core.Assets.defaultExchangeRates.json");
